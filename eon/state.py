...
class State:
    ...
    def __init__(self, statepath, statenumber, statelist, previous_state_num = -1,
        ...
        if config is None:
            raise TypeError("state requires a ConfigClass instance")
        self.config = config
    ...
    def get_displacement_atom_list(self, config: ConfigClass) -> str:
        """
        ...
        Returns:
            A string of atom indices for displacement.
        """
        ...
        script_config = utl.ScriptConfig.from_eon_config(config)
