...
[[nodiscard]] DimerRotationResult
runRotationSolver(const std::shared_ptr<Matter> &matter,
...
/// Run Lanczos, Davidson, or LOR. Classical returns nullopt (stock rotation loop).
[[nodiscard]] inline std::optional<DimerRotationResult>
runAlternativeRotation(DimerRotationBackend backend,
