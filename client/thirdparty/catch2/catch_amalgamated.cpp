...
public: // IMutableRegistryHub
  ...
  void
  registerListener(Detail::unique_ptr<EventListenerFactory> factory) override {
...
makeTestCaseInfo(StringRef _className, NameAndTags const &nameAndTags,
...
namespace {
static std::string
tryTranslators(std::vector<Detail::unique_ptr<IExceptionTranslator const>> const
                   &translators) {
...
static thread_local SourceLineInfo g_lastKnownLineInfo("DummyLocation",
...
IGeneratorTracker *
RunContext::createGeneratorTracker(StringRef generatorName,
                                   SourceLineInfo lineInfo,
...
void RunContext::popScopedMessage(MessageInfo const &message) {
  ...
  m_messages.erase(
      std::find_if(m_messages.begin(), m_messages.end(),
...
bool RunContext::lastAssertionPassed() { return Detail::g_lastAssertionPassed; }
