...
2. Prefer Trusted Publishing bound to the repo publish workflow
   (``.github/workflows/eon-schema-publish.yml``); details stay in maintainer
   runbooks, not site docs.
