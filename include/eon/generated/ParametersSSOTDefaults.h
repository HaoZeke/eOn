...
struct GeneratedDefaults {
  ...
  static constexpr auto OPTIMIZER_LBFGS_CURVATURE = std::string_view{"reset"};
  static constexpr auto OPTIMIZER_LBFGS_PROJECT_RIGID = false;
  ...
  static constexpr auto OPTIMIZER_XTSCI_HIGHS = false;
  static constexpr auto OPTIMIZER_XTSCI_MANIFOLD =
      std::string_view{"euclidean"};
